      ...
      <Slider {...settings}>
        {cards.map((card) => (
          <div className="col bg-transparent" key={card.id}>
            <div className="slide-card card mx-2 text-dark h-100 bg-light pt-1 px-2">
              <div className="container">
                ...
                <h4 className="text-center mb-2">{card.title}</h4>
                <p className="text-center para">{card.body}</p>
              </div>
              <a href=".">
                <button className="btn border-start-0 border-end-0  w-100 enroll">
                  Enroll Now
